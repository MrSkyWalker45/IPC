...
const NavOptions = () => {
  ...
  return (
    ...
    <View style={{ flex: 1 ,bottom:15}}>
      <ScrollView  style={tw`pt-10 z-50`} horizontal={true}>
        <View style={{ bottom: 24 }}> 
          <TouchableOpacity onPress={() => navigation.navigate('CSc')}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('CSc')} style={tw.style('pt-4',{opacity:chosen   ? 0.7 :1})} disabled={chosen}>
